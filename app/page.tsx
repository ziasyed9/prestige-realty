...
function AboutSection() {
  return (
    <section
      id="about"
      style={{ padding: "5rem 0", backgroundColor: "var(--color-stone-dark)" }}
    >
      <div className="container-site">
        <div className="about-grid">
          ...
          <div>
            ...
            <p style={{ color: "var(--color-navy-muted)", lineHeight: 1.8, marginBottom: "1.25rem" }}>
            ...
            <p style={{ color: "var(--color-navy-muted)", lineHeight: 1.8, marginBottom: "2rem" }}>
          ...
          <div className="stat-grid">
            {[
              ...
              <div key={stat.label} style={{
                ...
                <p style={{ color: "var(--color-navy-muted)", fontSize: "0.8rem" }}>{stat.label}</p>
              </div>
            ))}
          </div>
